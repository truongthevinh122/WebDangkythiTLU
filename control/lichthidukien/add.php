<?php
if (isset($_POST['add'])) {
$data = array("monthi_id" => $_POST['monthi_id'],"cathi_ten" => $_POST['cathi_ten'],"LTDK_ngaythi" => $_POST['LTDK_ngaythi']);
}
else {
  $data = array();
}
...
$chkt = curl_init('http://localhost:8235/api.dangkythi/api/tb_ltdk/create.php');
