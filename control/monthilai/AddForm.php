...
<div class="form-popup" id="AddForm">
  ...
  <form method="post" action="/api.dangkythi/control/monthilai/add.php" enctype="multipart/form-data" class="form-container">
    ...
    <div class="input-group">
      <input type="hidden" name="monthi_mota" value="1">
    </div>
