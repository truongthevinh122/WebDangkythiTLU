...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            <small>Đại học Thăng Long/</small> Danh sách kiểu thi
                        </h1>
                    </div>
                </div>
                 <!-- /. ROW  -->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <?php include "../control/kieuthi/dskieuthi.php" ?>
                    </div>
                    <!--End Advanced Tables -->
                </div>
            </div>
         ...
         <!-- /. PAGE WRAPPER  -->
     <!-- /. WRAPPER  -->
     <script src="/api.dangkythi/control/kieuthi/datatable.js"></script>
