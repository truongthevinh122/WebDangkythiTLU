			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            <small>Đại học Thăng Long/</small> Lịch thi dự kiến
                        </h1>
                    </div>
                </div>
                 <!-- /. ROW  -->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <?php include('../control/lichthidukien/filter_ky.php') ?>

                        <?php include('../control/lichthidukien/dslichthidk.php') ?>
              ...
              <div class="col-md-12">
                <div class="panel panel-default">
                  ...
                  <div class="panel panel-body">
                    <?php include('../control/lichthidukien/report.php') ?>
                  </div>
