		...
		tbl +='<tbody>';
			...
			$.each(ajax_data, function(index, val)
			{
				...
				tbl +='<tr row_id="'+row_id+'">';
					tbl +='<td ><div class="row_data" edit_type="click" col_name="monhoc_ma">'+val['monhoc_ma']+'</div></td>';
					tbl +='<td ><div class="row_data" edit_type="click" col_name="monhoc_ten">'+val['monhoc_ten']+'</div></td>';
					tbl +='<td ><div class="row_data" edit_type="click" col_name="bomon_ten">'+val['bomon_ten']+'</div></td>';
